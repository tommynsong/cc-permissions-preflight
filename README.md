...
- The identity needs to be able to read role assignments/definitions (e.g., Microsoft.Authorization/roleAssignments/read, .../roleDefinitions/read)
  ...
  - Microsoft Entra ID Permissions (Tenant Integration):
    - The identity must have the Global Administrator role assigned in Microsoft Entra ID.
...
#### Azure - Success Azure Resource Provider Registration Check

![alt text](utils/azure-rpr-check.png)

#### Azure - Fail Azure Resource Provider Registration Check

![alt text](utils/azure-rpr-check-fail.png)

#### Azure Subscription - Success Preflight Conditional Access Policiy Check

![alt text](utils/azure-cac-check.png)
...
#### Azure Subscription - Failed Preflight Conditional Access Policiy Check

![alt text](utils/azure-cac-check-fail.png)
...
#### Azure Tenant - Failed Preflight Permissions Management Group/Subscription Check

![alt text](utils/azure-tenant-permissions-failed.png)
